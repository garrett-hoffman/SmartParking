        ...
        BeaconControlActivityInterface // allow Fragments to control Beacon timing/mode & on/off
{
     ...
     * @param data
     */
    private static void setBeaconData(List<BeaconData> data) {
        beaconData = new ArrayList<BeaconData>();
        beaconData.addAll(data);
    }

    /**
     * Handler Class, that handles Beacon Service being able to communicate with UI Thread.
     */
    public class UIHanlder extends Handler {
         ...
         * @param activity
         */
        UIHanlder(MainActivity activity) {
    ...
    private onLocationUpdateInterface locationUpdateFragment;
     ...
     */
    public void setFragmentDefaults() {
        ...
        // Single Fragment Screen
        {
            ...
            if (fm.findFragmentById(R.id.main_fragment_container) == null) {
                fm.beginTransaction().add(R.id.main_fragment_container,
                        (Fragment) locationUpdateFragment).commit();
            }
        ...
        // Dual Fragment Screen
        {
            FragmentManager fm = getFragmentManager();
            if (fm.findFragmentById(R.id.main_fragment_container) == null) {
                fm.beginTransaction().add(R.id.main_fragment_container_2,
                        (Fragment) beaconControlFragment).commit();
            }
    ...
    public void onBeaconServiceConnect() {
        ...
        try {
            ...
            altBeaconManager.startRangingBeaconsInRegion(new Region("myRangingUniqueId", null, null, null));
    ...
    /**
     * This currently doesn't work, but leaving in for reference for now.
     */
    ...
    /**
     * This RangeNotifier receives the Beacon data and passes it to the fragment via onLocationUpdate()
     */
        ...
        public void didRangeBeaconsInRegion(Collection<Beacon> beacons, Region region) {
            if (beacons.size() > 0) {
                ...
                for (Beacon b : beacons) {
                    Log.i(LOG, "uuid:" + b.getServiceUuid() + ";id1:" + b.getId1() + ";rssi:" + b.getRssi());
